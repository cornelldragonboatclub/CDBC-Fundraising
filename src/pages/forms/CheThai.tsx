                ...
                {isFormOpen === false ? (
                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center z-10 relative">
                        ...
                        <p className="text-stone-600 leading-relaxed">
                            Thank you for your support! Our Chè Thái fundraiser is now closed. 
                            ...
                            <form onSubmit={handleSubmit} className="absolute inset-0 w-full h-full transition-transform duration-500 ease-in-out flex" style={{ transform: `translateX(-${currentStep * 100}%)` }}>
                                ...
                                <div className="w-full h-full flex-shrink-0 p-6 flex flex-col step-container overflow-y-auto">
                                    ...
                                    <div className="space-y-4 mb-6">
                                        <div>
                                            <label className="block text-sm font-medium text-stone-700 mb-1">Venmo ID, Zelle (Phone #), or "Cash" *</label>
